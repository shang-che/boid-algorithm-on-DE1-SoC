	Computer_System u0 (
		...
		.debug1_external_connection_export               (<connected-to-debug1_external_connection_export>),               //            debug1_external_connection.export
		.debug2_external_connection_export               (<connected-to-debug2_external_connection_export>),               //            debug2_external_connection.export
		.debug3_external_connection_export               (<connected-to-debug3_external_connection_export>),               //            debug3_external_connection.export
		.freq1_external_connection_export                (<connected-to-freq1_external_connection_export>),                //             freq1_external_connection.export
		.freq2_external_connection_export                (<connected-to-freq2_external_connection_export>),                //             freq2_external_connection.export
		.freq3_external_connection_export                (<connected-to-freq3_external_connection_export>),                //             freq3_external_connection.export
		.freq4_external_connection_export                (<connected-to-freq4_external_connection_export>),                //             freq4_external_connection.export
		.freq5_external_connection_export                (<connected-to-freq5_external_connection_export>),                //             freq5_external_connection.export
		...
		.right_audio_input_external_connection_export    (<connected-to-right_audio_input_external_connection_export>),    // right_audio_input_external_connection.export
